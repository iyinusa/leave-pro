<?php echo form_open_multipart('settings/modules/'.$param1.'/'.$param2.'/'.$param3, array('id'=>'bb_ajax_form', 'class'=>'form-horizontal')); ?>
<div class="row">
    ...
    <?php } else { // insert/edit view ?>
        <div class="col-sm-8 col-sm-offset-2">
            ...
            <div class="form-group text-center m-t-40">
                <div class="col-xs-12">
                    <button class="btn btn-success btn-block text-uppercase bb_form_btn" type="submit">
